...
namespace System.Web.WebPages {
    ...
    internal class PageDataDictionary<TValue> : IDictionary<object, TValue> {
        ...
        static internal IDictionary<object, dynamic> CreatePageDataFromParameters(IDictionary<object, dynamic> previousPageData, params object[] data) {
            ...
            if (data != null && data.Length > 0) {
                ...
                if (Util.IsAnonymousType(type)) {
                    // Anonymous type
                    Util.AddAnonymousTypeObjectToDictionary(pageData.StringDictionary, first);
                }
