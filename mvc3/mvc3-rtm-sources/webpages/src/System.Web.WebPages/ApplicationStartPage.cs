...
namespace System.Web.WebPages {
    public abstract class ApplicationStartPage : WebPageExecutingBase {
        ...
        public static HtmlString Markup {
            get;
            private set;
        }
        ...
        internal static void ExecuteStartPage(HttpApplication application, Action<string> monitorFile, Func<string, bool> fileExists, Func<string, object> createInstance, IEnumerable<string> supportedExtensions) {
            try {
        ...
        internal static void ExecuteStartPageInternal(HttpApplication application, Action<string> monitorFile, Func<string, bool> fileExists, Func<string, object> createInstance, IEnumerable<string> supportedExtensions) {
            ...
            foreach (var extension in supportedExtensions) {
                ...
                if (startPage == null) {
                    startPage = (ApplicationStartPage)createInstance(vpath);
