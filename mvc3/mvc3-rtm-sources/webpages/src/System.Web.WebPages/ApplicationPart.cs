    ...
    public class ApplicationPart {
        ...
        internal ApplicationPart(IResourceAssembly assembly, string rootVirtualPath) {
            ...
            _applicationPartResources = new Lazy<IDictionary<string, string>>(
                () => Assembly.GetManifestResourceNames().ToDictionary(key => key, key => key, StringComparer.OrdinalIgnoreCase)
            );
            _applicationPartName = new Lazy<string>(
                () => Assembly.Name
            );
        }

        internal IResourceAssembly Assembly {
            get;
            private set;
        }

        internal string RootVirtualPath {
            get;
            private set;
        }
        ...
        internal string Name {
            get {
                return _applicationPartName.Value;
            }
        }

        internal IDictionary<string, string> ApplicationPartResources {
            get {
                return _applicationPartResources.Value;
            }
        }
