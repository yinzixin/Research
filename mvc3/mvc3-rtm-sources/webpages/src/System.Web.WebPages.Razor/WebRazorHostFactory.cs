...
namespace System.Web.WebPages.Razor {
    public class WebRazorHostFactory {
        ...
        public static WebPageRazorHost CreateHostFromConfig(string virtualPath, string physicalPath) {
            if (String.IsNullOrEmpty(virtualPath)) { throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, CommonResources.Argument_Cannot_Be_Null_Or_Empty, "virtualPath"), "virtualPath"); }
...
#if CODE_COVERAGE
        [ExcludeFromCodeCoverage] // JUSTIFICATION: VirtualPathUtility.ToAppRelative is only available in ASP.Net environment
#endif
...
#if CODE_COVERAGE
        [ExcludeFromCodeCoverage] // JUSTIFICATION: BuildManager.GetType is only available in ASP.Net environment
#endif
