...
namespace Microsoft.Web.Helpers.Resources {
    using System;
    ...
    internal class HelpersToolkitResources {
        ...
        /// </summary>
        internal static string BingSearch_SearchButtonText {
            get {
                return ResourceManager.GetString("BingSearch_SearchButtonText", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Search Bing.
        /// </summary>
        internal static string BingSearch_Title {
            get {
                return ResourceManager.GetString("BingSearch_Title", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Static properties cannot be set to a new value after being initialized. If you want to reset the value of a static property, you must restart the application. You can do this by making a change in the _AppStart.cshtml, Web.config, or Global.asax files..
        /// </summary>
        internal static string StaticPropertyCannotBeReset {
            get {
                return ResourceManager.GetString("StaticPropertyCannotBeReset", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Please ensure that Themes.DefaultTheme is set to a valid theme name..
        /// </summary>
        internal static string Themes_CannotGetDefaultTheme {
            get {
                return ResourceManager.GetString("Themes_CannotGetDefaultTheme", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to Themes.Initialize has already been called.
        /// </summary>
        internal static string Themes_InitializeAlreadyCalled {
            get {
                return ResourceManager.GetString("Themes_InitializeAlreadyCalled", resourceCulture);
            }
        }
