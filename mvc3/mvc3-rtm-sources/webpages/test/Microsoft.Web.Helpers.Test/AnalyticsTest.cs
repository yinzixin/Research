...
namespace Microsoft.Web.Helpers.Test
{
    ...
    public class AnalyticsTest
    {
        ...
        public void GetYahooAnalyticsHtmlTest() {
            ...
            Assert.IsTrue(actual.Contains(".yahoo.com") && actual.Contains("My_yahoo_account"));
        }
        ...
        public void GetStatCounterAnalyticsHtmlTest() {
            ...
            Assert.IsTrue(actual.Contains("statcounter.com/counter/counter_xhtml.js") && 
        ...
        public void GetYahooAnalyticsEscapesJavascript() {
            ...
            string actual = Analytics.GetYahooHtml(account).ToString();
            string expected = "<SCRIPT language=\"JavaScript\" type=\"text/javascript\">\n" +
                    "<!-- Yahoo! Inc.\n" +
        ...
        public void GetStatCounterAnalyticsEscapesCorrectly() {
            ...
            string expected = "<!-- Start of StatCounter Code -->\n" +
                    "<script type=\"text/javascript\">\n" +
                    "var sc_project=2;\n" +
                    "var sc_invisible=1;\n" +
