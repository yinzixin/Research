namespace System.Web.Mvc.Test {
    ...
    public class TagBuilderTest {
        ...
        public void CreateSanitizedIdDefaultsToHtmlHelperIdAttributeDotReplacement() {
            // Arrange
            String defaultReplacementChar = System.Web.WebPages.Html.HtmlHelper.IdAttributeDotReplacement;

            // Act
            string sanitizedId = TagBuilder.CreateSanitizedId("Hello world");

            // Assert
            Assert.AreEqual("Hello" + defaultReplacementChar + "world", sanitizedId);
        }
        ...
        public void InnerHtmlProperty() {
            ...
            // Act & Assert
            Assert.AreEqual(String.Empty, builder.InnerHtml);
            builder.InnerHtml = "foo";
            Assert.AreEqual("foo", builder.InnerHtml);
