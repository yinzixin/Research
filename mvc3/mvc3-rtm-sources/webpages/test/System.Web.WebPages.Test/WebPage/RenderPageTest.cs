...
namespace System.Web.WebPages.Test {
    ...
    public class RenderPageTest {
        ...
        public void RenderPageAnonymousTypeTest() {
            ...
            var result = Utils.RenderWebPageWithSubPage(
                p => {
                    p.Write(p.RenderPage("subpage.cshtml", new { HelloKey = "hellovalue", MyKey = "myvalue" }));
                },
                p => {
            ...
            Assert.AreEqual("hellovalue myvalue hellovalue myvalue", result);
        }
        ...
        public void RenderPageDictionaryTest() {
            ...
            Assert.AreEqual("1 hello System.Collections.Generic.Dictionary`2[System.String,System.Object]", result);
        }
        ...
        public void RenderPageListTest() {
            ...
            var result = Utils.RenderWebPageWithSubPage(
                p => {
                    p.Write(p.RenderPage("subpage.cshtml", "hello", "world", 1, 2, 3));
                },
                p => {
                    p.Write(p.PageData[0]);
                    p.Write(" ");
            ...
            Assert.AreEqual("hello world 1 2 3", result);
        }
        ...
        private class Person { public string FirstName { get; set; } }
        ...
        public void RenderPageDynamicValueTest() {
            ...
            var result = Utils.RenderWebPageWithSubPage(
                p => {
                    p.Write(p.RenderPage("subpage.cshtml", new Person() { FirstName = "MyFirstName" }));
                },
                p => {
                    p.Write(p.PageData[0].FirstName);
                });
            Assert.AreEqual("MyFirstName", result);
        }
        ...
        public void OverridePageDataSetByParentTest() {
            ...
            Assert.AreEqual("worldworld", result);
        }
        ...
        public void RenderPageMissingKeyTest() {
            ...
            Assert.AreEqual("null1 hello y null2 ", result);
        }
        ...
        public void RenderPageDynamicDictionaryMissingKeyTest() {
            ...
            Assert.AreEqual("null1 hello ", result);
            result = Utils.RenderWebPageWithSubPage(
                p => {
                    p.Write(p.RenderPage("subpage.cshtml", "x", "y", "z"));
                }, subPage);
            Assert.AreEqual("y null2 ", result);
        ...
        public void RenderPageNoArgumentsTest() {
            ...
            Assert.AreEqual("null1 null2 null3", result);
        }
        ...
        public void RenderPageNestedSubPageListTest() {
            ...
            page.PageInstances[subpage1Path] = subpage1;
            subpage1.PageInstances[subpage2Path] = subpage2;
            var result = Utils.RenderWebPage(page);
            Assert.AreEqual("null a b c sub1null3 x y z sub2null3", result);
        }
        ...
        public void RenderPageNestedSubPageAnonymousTypeTest() {
            ...
            subpage1.PageInstances[subpage2Path] = subpage2;
            var result = Utils.RenderWebPage(page);
            Assert.AreEqual("null 1 hello sub1nullx sub1nully sub2nullfoo world good bye", result);
        }
        ...
        public void RenderPageNestedParentPageDataTest() {
            ...
            page.PageInstances[subpage1Path] = subpage1;
            subpage1.PageInstances[subpage2Path] = subpage2;
            subpage2.PageInstances[subpage3Path] = subpage3;
            var result = Utils.RenderWebPage(page);
            Assert.AreEqual("<subpage1>value1<subpage2>value1<subpage3>value4</subpage3></subpage2>value1<subpage2>value2<subpage3>value4</subpage3></subpage2></subpage1>", result);
        }
        ...
        public void RenderPageInvalidPageType() {
            ...
            page.PageInstances[pagePath] = new object();
            ...
            page.PageInstances[pagePath] = null;
            ExceptionAssert.Throws<HttpException>(() => Utils.RenderWebPage(page),
                String.Format(CultureInfo.CurrentCulture, WebPageResources.WebPage_InvalidPageType, pagePath));
        }
        ...
        public void RenderPageValidPageType() {
            ...
            page.PageInstances[pagePath] = Utils.CreatePage(p => p.Write(contents));
