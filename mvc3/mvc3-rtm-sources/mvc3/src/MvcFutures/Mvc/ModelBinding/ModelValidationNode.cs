namespace Microsoft.Web.Mvc.ModelBinding {
    ...
    public sealed class ModelValidationNode {
        ...
        public void Validate(ControllerContext controllerContext, ModelValidationNode parentNode) {
            ...
            ModelValidatingEventArgs eValidating = new ModelValidatingEventArgs(controllerContext, parentNode);
            ...
            ModelValidatedEventArgs eValidated = new ModelValidatedEventArgs(controllerContext, parentNode);
