namespace Microsoft.Web.Mvc {
    ...
    // stash a cache object that can copied around as a prototype to make creation and
    // computation quicker. It delegates theretrieval of values to getter methods, the results
    ...
    public abstract class CachedModelMetadata<TPrototypeCache> : ModelMetadata {
        ...
        protected TPrototypeCache PrototypeCache {
            get;
            set;
        }
        ...
        protected override sealed string GetSimpleDisplayText() {  // Rename for consistency
