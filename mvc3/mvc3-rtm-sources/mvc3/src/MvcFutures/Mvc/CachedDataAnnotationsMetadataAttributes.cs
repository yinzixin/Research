namespace Microsoft.Web.Mvc {
    ...
    public class CachedDataAnnotationsMetadataAttributes {
        ...
        public DisplayColumnAttribute DisplayColumn {
            get;
            protected set;
        }
        ...
        public HiddenInputAttribute HiddenInput {
            get;
            protected set;
        }
        ...
        public ScaffoldColumnAttribute ScaffoldColumn {
            get;
            protected set;
        }

        public UIHintAttribute UIHint {
            get;
            protected set;
        }
    }
