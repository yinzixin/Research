namespace System.Web.Mvc.Test {
    ...
    public class ViewMasterPageTest {
        ...
        public void ViewBagProperty_ReflectsViewData() {
            ...
            // Act & Assert
            Assert.IsNotNull(masterPage.ViewBag);
            Assert.AreEqual(1, masterPage.ViewBag.A);
        }
        ...
        public void ViewBagProperty_PropagatesChangesToViewData() {
            ...
            // Assert
            Assert.AreEqual("foo", masterPage.ViewData["A"]);
            Assert.AreEqual(2, masterPage.ViewData["B"]);
        }
