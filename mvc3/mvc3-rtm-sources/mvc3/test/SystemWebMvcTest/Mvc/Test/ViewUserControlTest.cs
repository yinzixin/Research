namespace System.Web.Mvc.Test {
    ...
    public class ViewUserControlTest {
        ...
        public void ViewBagProperty_ReflectsViewData() {
            ...
            // Act & Assert
            Assert.IsNotNull(userControl.ViewBag);
            Assert.AreEqual(1, userControl.ViewBag.A);
        }
        ...
        public void ViewBagProperty_ReflectsNewViewDataInstance() {
            ...
            // Act & Assert
            Assert.AreEqual("bar", userControl.ViewBag.A);
        }
        ...
        public void ViewBagProperty_PropagatesChangesToViewData() {
            ...
            // Assert
            Assert.AreEqual("foo", userControl.ViewData["A"]);
            Assert.AreEqual(2, userControl.ViewData["B"]);
        }
