namespace System.Web.Mvc.Test {
    ...
    public class ControllerTest {
        ...
        public void HttpNotFoundWithStatusDescription() {
            ...
            // Assert
            Assert.IsNotNull(result);
            Assert.AreEqual("I lost it", result.StatusDescription);
            Assert.AreEqual(404, result.StatusCode);
        }
        ...
        public void RedirectToActionSimpleOverridesCallLegacyMethod() {
            ...
            controllerMock.Setup(c => c.RedirectToAction(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<RouteValueDictionary>())).Callback(() => {
                invocationCount++;
            });
        ...
        public void RedirectToActionPermanentWithObjectDictionary() {
            ...
            Assert.IsTrue(result.Permanent);
            Assert.AreEqual("SomeOtherAction", result.RouteValues["action"]);
            Assert.AreEqual("bar", result.RouteValues["foo"]);
            Assert.AreEqual("SomeController", result.RouteValues["controller"]);
        }
        ...
        public void RedirectToRouteSimpleOverridesCallLegacyMethod() {
            ...
            int invocationCount = 0;
            Mock<Controller> controllerMock = new Mock<Controller>();
            controllerMock.Setup(c => c.RedirectToRoute(It.IsAny<string>(), It.IsAny<RouteValueDictionary>())).Callback(() => {
                invocationCount++;
            });
        ...
        public void TempDataMovedToPreviousTempDataInDestinationController() {
            ...
            // Assert
            Assert.IsTrue(mockDestinationController.Object.TempData.ContainsKey("Key"), "The key should exist in the new TempData");

            // Act
            mockDestinationController.Object.TempData["NewKey"] = "NewValue";
            Assert.IsTrue(mockDestinationController.Object.TempData.ContainsKey("NewKey"), "The new key should exist in the new TempData");
            ...
            // Assert
            Assert.IsTrue(mockSecondDestinationController.Object.TempData.ContainsKey("Key"), "The key should exist in the new TempData");
            Assert.IsTrue(mockSecondDestinationController.Object.TempData.ContainsKey("NewKey"), "The new key should exist in the new TempData");
        }
