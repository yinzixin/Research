namespace System.Web.Mvc.ExpressionUtil.Test {
    ...
    public class FingerprintingExpressionVisitorTest {
        ...
        public void Visit_Null() {
            ...
            // Assert
            Assert.AreEqual(0, capturedConstants.Count);
        ...
        public void Visit_Unknown() {
            ...
            // Assert
            Assert.IsNull(fingerprint, "Cannot fingerprint a ctor, so should just return null.");
            Assert.IsNull(capturedConstants, "Cannot fingerprint a ctor, so should just return null.");
        }
        ...
        public void VisitBinary() {
            ...
            // Assert
            CollectionAssert.AreEqual(new object[] { 42, 84 }, capturedConstants.ToArray());
            AssertChainEquals(fingerprint,
        ...
        public void VisitConditional() {
            ...
            // Assert
            CollectionAssert.AreEqual(new object[] { true, 42, 84 }, capturedConstants.ToArray());
            AssertChainEquals(fingerprint,
        ...
        public void VisitConstant() {
            ...
            // Assert
            CollectionAssert.AreEqual(new object[] { 42 }, capturedConstants.ToArray());
            AssertChainEquals(fingerprint,
                new ConstantExpressionFingerprint(ExpressionType.Constant, typeof(int)));
        }
        ...
        public void VisitTypeBinary() {
            ...
            // Assert
            CollectionAssert.AreEqual(new object[] { "hello" }, capturedConstants.ToArray());
            AssertChainEquals(fingerprint,
