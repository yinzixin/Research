namespace System.Web.Mvc.ExpressionUtil.Test {
    ...
    public class HoistingExpressionVisitorTest {
        ...
        public void Hoist() {
            ...
            CollectionAssert.AreEqual(new object[] { 0, 1 }, capturedConstants.ToArray()); // these are constants from the hoisted expression (array indexes), not the original expression
            FingerprintingExpressionVisitorTest.AssertChainEquals(fingerprint,
