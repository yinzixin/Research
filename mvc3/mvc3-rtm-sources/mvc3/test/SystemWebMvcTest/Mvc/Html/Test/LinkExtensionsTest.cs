namespace System.Web.Mvc.Html.Test {
    ...
    public class LinkExtensionsTest {
        ...
        public void ActionLinkParametersNeedEscaping() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a href=""" + AppPathModifier + @"/app/home/new%20action%3C%26%3E%22"">linktext&lt;&amp;&gt;&quot;</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithControllerNameAndObjectPropertiesWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a foo-baz=""baz"" href=""" + AppPathModifier + @"/app/home2/newaction/someid"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void ActionLinkWithFragmentAndAttributesWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a foo-baz=""baz"" href=""http://foo.bar.com" + AppPathModifier + @"/app/home2/newaction/someid#foo"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void RouteLinkWithFragmentAndAttributesWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a foo-baz=""baz"" href=""http://foo.bar.com" + AppPathModifier + @"/app/named/home2/newaction/someid#foo"">linktext</a>", html.ToHtmlString());
        }
        ...
        public void RouteLinkWithRouteNameAndObjectPropertiesWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual<string>(@"<a foo-baz=""baz"" href=""" + AppPathModifier + @"/app/named/home2/newaction/someid"">linktext</a>", html.ToHtmlString());
        }
    }
}
