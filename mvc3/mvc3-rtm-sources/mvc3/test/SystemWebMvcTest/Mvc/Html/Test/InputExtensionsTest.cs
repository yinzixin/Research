namespace System.Web.Mvc.Html.Test {
    ...
    public class InputExtensionsTest {
        ...
        public void CheckBoxWithOnlyName_Unobtrusive() {
            ...
            // Assert
            Assert.AreEqual(@"<input checked=""checked"" data-val=""true"" data-val-type=""error"" id=""foo"" name=""foo"" type=""checkbox"" value=""true"" />" +
                @"<input name=""foo"" type=""hidden"" value=""false"" />",
                html.ToHtmlString());
        }
        ...
        public void CheckBoxWithNameAndObjectAttributeWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<input checked=""checked"" foo-baz=""BazObjValue"" id=""foo"" name=""foo"" type=""checkbox"" value=""true"" />" +
                @"<input name=""foo"" type=""hidden"" value=""false"" />",
                html.ToHtmlString());
        }
        ...
        public void CheckBoxWithObjectAttributeWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<input foo-baz=""BazObjValue"" id=""foo"" name=""foo"" type=""checkbox"" value=""true"" />" +
                @"<input name=""foo"" type=""hidden"" value=""false"" />",
                html.ToHtmlString());
        }
        ...
        public void HiddenWithExplicitValueAndAttributesObjectWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<input foo-baz=""BazObjValue"" id=""foo"" name=""foo"" type=""hidden"" value=""DefaultFoo"" />", html.ToHtmlString());
        }
        ...
        public void PasswordWithExplicitValue_Unobtrusive() {
            ...
            // Assert
            Assert.AreEqual(@"<input data-val=""true"" data-val-type=""error"" id=""foo"" name=""foo"" type=""password"" value=""DefaultFoo"" />", html.ToHtmlString());
        }
        ...
        public void PasswordWithImplicitValueAndAttributesObjectWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<input foo-baz=""BazObjValue"" id=""foo"" name=""foo"" type=""password"" />", html.ToHtmlString());
        }
        ...
        [TestMethod]
        public void PasswordForWithDeepValueWithNullModel_Unobtrusive() {  // Dev10 Bug #936192
            // Arrange
            ...
            // Assert
            Assert.AreEqual(@"<input data-val=""true"" data-val-required=""The foo field is required."" id=""contained_foo"" name=""contained.foo"" type=""password"" />", html.ToHtmlString());
        }
        ...
        public void RadioButtonWithNameAndValue_Unobtrusive() {
            ...
            // Assert
            Assert.AreEqual(@"<input checked=""checked"" data-val=""true"" data-val-type=""error"" id=""foo"" name=""foo"" type=""radio"" value=""ViewDataFoo"" />", html.ToHtmlString());
        }
        ...
        public void RadioButtonWithObjectAttributeWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<input foo-baz=""BazObjValue"" id=""foo"" name=""foo"" type=""radio"" value=""fooValue"" />", html.ToHtmlString());
        }
        ...
        public void RadioButtonWithValueAndObjectAttributeWithUnderscoresUnchecked() {
            ...
            // Assert
            Assert.AreEqual(@"<input foo-baz=""BazObjValue"" id=""foo"" name=""foo"" type=""radio"" value=""bar"" />", html.ToHtmlString());
        }
        ...
        public void TextBoxWithExplicitValue_Unobtrusive() {
            ...
            // Assert
            Assert.AreEqual(@"<input data-val=""true"" data-val-type=""error"" id=""foo"" name=""foo"" type=""text"" value=""DefaultFoo"" />", html.ToHtmlString());
        }
        ...
        public void TextBoxWithImplicitValueAndAttributesObjectWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<input foo-baz=""BazObjValue"" id=""foo"" name=""foo"" type=""text"" value=""ViewDataFoo"" />", html.ToHtmlString());
        }
        ...
        public void TextBoxForWithAttributesObjectWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<input foo-baz=""BazObjValue"" id=""foo"" name=""foo"" type=""text"" value=""ViewItemFoo"" />", html.ToHtmlString());
        }
