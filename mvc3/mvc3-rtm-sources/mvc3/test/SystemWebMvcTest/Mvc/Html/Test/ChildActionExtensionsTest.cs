namespace System.Web.Mvc.Html.Test {
    ...
    public class ChildActionExtensionsTest {
        ...
        public void PassedRouteValuesOverrideParentRequestRouteValues() {
            ...
            Assert.AreEqual("newValue2", (routeData.Values[ChildActionValueProvider.ChildActionValuesKey] as DictionaryValueProvider<object>).GetValue("name2").RawValue);
        }
        ...
        public void NoChildActionValuesDictionaryCreatedIfNoRouteValuesPassed() {
            ...
            // Assert
            RouteData routeData = mvcHandler.RequestContext.RouteData;
            Assert.IsNull(routeData.Values[ChildActionValueProvider.ChildActionValuesKey]);
        }
        ...
        public void RouteValuesDoesNotIncludeExplicitlyPassedAreaName() {
            ...
            Assert.IsNull((routeData.Values[ChildActionValueProvider.ChildActionValuesKey] as DictionaryValueProvider<object>).GetValue("area"));
        }
        ...
        public void RouteValuesIncludeExplicitlyPassedAreaNameIfAreasNotInUse() {
            ...
            Assert.AreEqual("myArea", (routeData.Values[ChildActionValueProvider.ChildActionValuesKey] as DictionaryValueProvider<object>).GetValue("area").RawValue);
        }
