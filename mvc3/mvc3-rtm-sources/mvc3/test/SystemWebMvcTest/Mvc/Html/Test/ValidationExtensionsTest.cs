namespace System.Web.Mvc.Html.Test {
    ...
    public class ValidationExtensionsTest {
        ...
        public void ValidationMessageReturnsWithObjectAttributesWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<span class=""field-validation-error"" foo-bar=""bar"">foo error &lt;1&gt;</span>", html.ToHtmlString());
        }
        ...
        public void ValidationMessageReturnsWithCustomMessageAndObjectAttributesWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<span class=""field-validation-error"" foo-baz=""baz"">bar error</span>", html.ToHtmlString());
        }
        ...
        public void ValidationMessageWithClientValidation_ExplicitMessage_Valid_Unobtrusive() {
            ...
            try {
                ...
                // Assert
                Assert.AreEqual(@"<span class=""field-validation-valid"" data-valmsg-for=""baz"" data-valmsg-replace=""false"">some explicit message</span>", html.ToHtmlString(),
                    "ValidationMessage() should always return something if client validation is enabled.");
            }
            finally {
                ModelValidatorProviders.Providers.Clear();
...
<li>bar error 2</li>
        ...
        public void ValidationSummaryDoesNotAddIdIfUnobtrusiveJavaScriptEnabled() {
            ...
            // Assert
            Assert.AreEqual(@"<div class=""validation-summary-errors"" data-valmsg-summary=""true""><ul><li>foo error &lt;1&gt;</li>
<li>foo error 2</li>
<li>bar error &lt;1&gt;</li>
<li>bar error 2</li>
...
<li>bar error 2</li>
        ...
        [TestMethod]
        public void ValidationSummaryWithNoErrors_ReturnsNullIfUnobtrusiveJavaScriptEnabled() {
            // Arrange
            HtmlHelper htmlHelper = MvcHelper.GetHtmlHelper(new ViewDataDictionary());
            htmlHelper.ViewContext.ClientValidationEnabled = true;
            htmlHelper.ViewContext.UnobtrusiveJavaScriptEnabled = true;
...
<li>bar error 2</li>
        ...
        public void ValidationSummaryWithObjectAttributesWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<div class=""validation-summary-errors"" foo-baz=""baz""><ul><li>foo error &lt;1&gt;</li>
<li>foo error 2</li>
<li>bar error &lt;1&gt;</li>
<li>bar error 2</li>
</ul></div>"
