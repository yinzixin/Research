namespace Microsoft.Web.Mvc.Test {
    ...
    public class RadioExtensionsTest {
        ...
        public void RadioButtonListWithObjectAttributesWithUnderscores() {
            ...
            // Assert
            Assert.AreEqual(@"<input foo-bar=""baz"" id=""FooList"" name=""FooList"" type=""radio"" value=""foo"" />", html[0].ToHtmlString());
            Assert.AreEqual(@"<input foo-bar=""baz"" id=""FooList"" name=""FooList"" type=""radio"" value=""bar"" />", html[1].ToHtmlString());
            Assert.AreEqual(@"<input checked=""checked"" foo-bar=""baz"" id=""FooList"" name=""FooList"" type=""radio"" value=""baz"" />", html[2].ToHtmlString());
        }
