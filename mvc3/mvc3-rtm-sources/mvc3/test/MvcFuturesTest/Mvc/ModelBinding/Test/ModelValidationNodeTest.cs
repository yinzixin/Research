namespace Microsoft.Web.Mvc.ModelBinding.Test {
    ...
    public class ModelValidationNodeTest {
        ...
        public void CombineWith_OtherNodeIsSuppressed_DoesNothing() {
            ...
            ModelValidationNode[] expectedChildNodes = new ModelValidationNode[] {
                allChildNodes[0]
            };
            ...
            // Assert
            CollectionAssert.AreEqual(
                new string[] { "Validating parent1.", "Validated parent1." },
                log);
            CollectionAssert.AreEqual(expectedChildNodes, parentNode1.ChildNodes.ToArray());
        }
