namespace Microsoft.Web.Mvc.ModelBinding.Test {
    ...
    public class MutableObjectModelBinderTest {
        ...
        public void CreateModel() {
            ...
            // Assert
            Assert.IsInstanceOfType(retModel, typeof(Person));
        }
        ...
        public void EnsureModel_ModelIsNull_CallsCreateModel() {
            ...
            // Assert
            Assert.IsNull(originalModel);
            Assert.IsInstanceOfType(newModel, typeof(Person));
            mockTestableBinder.Verify();
        }
        ...
        public void NullCheckFailedHandler_ModelStateAlreadyInvalid_DoesNothing() {
            ...
            // Assert
            Assert.IsFalse(controllerContext.Controller.ViewData.ModelState.ContainsKey("foo"), "ModelState shouldn't have been touched since it was already invalid.");
        }
        ...
        public void NullCheckFailedHandler_ModelStateValid_AddsErrorString() {
            ...
            // Assert
            Assert.IsTrue(controllerContext.Controller.ViewData.ModelState.ContainsKey("foo"), "ModelState should've been updated with error.");
            Assert.AreEqual("A value is required.", controllerContext.Controller.ViewData.ModelState["foo"].Errors[0].ErrorMessage);
        }
        ...
        public void ProcessDto_BindRequiredFieldMissing_Throws() {
            ...
            Assert.AreEqual("original value", model.Name, "Model shouldn't have been changed.");
        ...
        public void ProcessDto_Success() {
            ...
            Assert.AreEqual(dob, model.DateOfBirth, "DateOfBirth shouldn't have been modified.");
...
Parameter name: value", bindingContext.ModelState["foo.NameNoAttribute"].Errors[0].Exception.Message);
        ...
        private sealed class ModelWhosePropertySetterThrows {
            ...
            public string Name {
                ...
                set {
                    throw new ArgumentException("This is an exception.", "value");
                }
            }
            ...
            public string NameNoAttribute {
                ...
                set {
                    throw new ArgumentException("This is a different exception.", "value");
                }
            }
        }
